...
public class ProductServiceImpl implements ProductService {
    ...
    public List<ProductDto> ReadAllProduct() {
        ...
        List<ProductDto> collect = all.stream().map(dto -> new ProductDto(dto.getProductId(), dto.getProductName(), dto.getDescription(), dto.getPrice(), dto.getWeight())).collect(Collectors.toList());
