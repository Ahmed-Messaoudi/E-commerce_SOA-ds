...
import com.organica.payload.ProductCreateDto;
...
public class ProductControllers {
    ...
    public ResponseEntity<ProductDto> CreateProduct(@RequestBody ProductCreateDto productCreateDto) throws IOException {
        ProductDto productDto = new ProductDto();
        productDto.setProductName(productCreateDto.getProductName());
        productDto.setDescription(productCreateDto.getDescription());
        productDto.setWeight(productCreateDto.getWeight());
        productDto.setPrice(productCreateDto.getPrice());
        //productDto.setImg("image".getBytes());
    ...
    public ResponseEntity<ProductDto> UpdateProduct(@RequestParam MultiValueMap<String, String> formData, @RequestParam("img") MultipartFile file,@PathVariable Integer ProductId) throws IOException {
        ...
        //productDto.setImg(file.getBytes("image"));
